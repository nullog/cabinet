...
import top.itmp.cabinet.BuildConfig;
...
import top.itmp.cabinet.fragments.ChangelogDialog;
import top.itmp.cabinet.fragments.NavigationDrawerFragment;
import top.itmp.cabinet.fragments.content.ArchiveFragment;
import top.itmp.cabinet.fragments.content.ContentFragment;
import top.itmp.cabinet.fragments.content.DirectoryFragment;
import top.itmp.cabinet.plugins.PluginDataProvider;
import top.itmp.cabinet.plugins.base.PluginConstants;
import top.itmp.cabinet.ui.base.CrumbsActivity;
import top.itmp.cabinet.utils.BackgroundThread;
import top.itmp.cabinet.utils.StorageUtils;
import top.itmp.cabinet.utils.ThemeUtils;
import top.itmp.cabinet.utils.Utils;
import top.itmp.cabinet.utils.ViewUtils;
import top.itmp.cabinet.views.BreadCrumbLayout;
import top.itmp.cabinet.views.ScrimInsetsFrameLayout;
                            ...
                            public void onPositive(MaterialDialog dialog) {
                                ...
                                try {
                                    startActivity(new Intent(Intent.ACTION_VIEW)
                                            .setData(Uri.parse("market://details?id=top.itmp.cabinet")));
                                } catch (ActivityNotFoundException e) {
                                    try {
                                        startActivity(new Intent(Intent.ACTION_VIEW)
                                                .setData(Uri.parse("https://play.google.com/store/apps/details?id=top.itmp.cabinet")));
