package top.itmp.cabinet.services;
...
import top.itmp.cabinet.plugins.PluginFramework;
import top.itmp.cabinet.plugins.base.PluginConstants;
import top.itmp.cabinet.ui.AudioInitActivity;
...
public class AudioService extends Service implements AudioManager.OnAudioFocusChangeListener {
    ...
    private final static String ACTION_TOGGLE = "top.itmp.cabinet.services.AudioService.TOGGLE";
    private final static String ACTION_PREVIOUS = "top.itmp.cabinet.services.AudioService.PREVIOUS";
    private final static String ACTION_CLOSE = "top.itmp.cabinet.services.AudioService.CLOSE";
    private final static String ACTION_NEXT = "top.itmp.cabinet.services.AudioService.NEXT";
